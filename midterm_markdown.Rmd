...
The variables `mean_border_patrol`, `mean_border_milit`, and `mean_border_legal` use data from the ANES 2024 Pilot Study to measure respondent beliefs about border issues.
The study asked respondents the following questions:
